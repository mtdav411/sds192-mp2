...
```
## Data Wrangling
This project is divided into two parts. In part 1, we aim to figure out how the contribution amount from the committees  is distributed according to different organization types in Massachussates. In part 2, we generalize our analysis to all individual states that the dataset contains. We combine our own data frames from getting variables mainly from raw data sets "individuals" and "committees". There are five organization types denoted as five letters in the raw data sets and we derive their meanings from original data set dictionary and rename them into plain English for easier understanding. 
